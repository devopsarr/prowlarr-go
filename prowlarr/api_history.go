...
func (a *HistoryAPIService) GetHistoryExecute(r ApiGetHistoryRequest) (*HistoryResourcePagingResource, *http.Response, error) {
	...
	if r.successful != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "successful", r.successful, "form", "")
	}
	if r.downloadId != nil {
	...
	if r.indexerIds != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "indexerIds", s.Index(i).Interface(), "form", "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "indexerIds", t, "form", "multi")
		}
	}
...
func (a *HistoryAPIService) ListHistoryIndexerExecute(r ApiListHistoryIndexerRequest) ([]HistoryResource, *http.Response, error) {
	...
	if r.indexerId != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "indexerId", r.indexerId, "form", "")
	}
	if r.eventType != nil {
