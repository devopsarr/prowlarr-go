...
type IndexerBulkResource struct {
	...
	RejectBlocklistedTorrentHashesWhileGrabbing NullableBool `json:"rejectBlocklistedTorrentHashesWhileGrabbing,omitempty"`
}
...
// GetRejectBlocklistedTorrentHashesWhileGrabbing returns the RejectBlocklistedTorrentHashesWhileGrabbing field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *IndexerBulkResource) GetRejectBlocklistedTorrentHashesWhileGrabbing() bool {
	if o == nil || IsNil(o.RejectBlocklistedTorrentHashesWhileGrabbing.Get()) {
		var ret bool
		return ret
	}
	return *o.RejectBlocklistedTorrentHashesWhileGrabbing.Get()
}

// GetRejectBlocklistedTorrentHashesWhileGrabbingOk returns a tuple with the RejectBlocklistedTorrentHashesWhileGrabbing field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *IndexerBulkResource) GetRejectBlocklistedTorrentHashesWhileGrabbingOk() (*bool, bool) {
	...
	return o.RejectBlocklistedTorrentHashesWhileGrabbing.Get(), o.RejectBlocklistedTorrentHashesWhileGrabbing.IsSet()
}
...
func (o *IndexerBulkResource) HasRejectBlocklistedTorrentHashesWhileGrabbing() bool {
	if o != nil && o.RejectBlocklistedTorrentHashesWhileGrabbing.IsSet() {
		return true
	}
...
// SetRejectBlocklistedTorrentHashesWhileGrabbing gets a reference to the given NullableBool and assigns it to the RejectBlocklistedTorrentHashesWhileGrabbing field.
func (o *IndexerBulkResource) SetRejectBlocklistedTorrentHashesWhileGrabbing(v bool) {
	o.RejectBlocklistedTorrentHashesWhileGrabbing.Set(&v)
}
...
func (o *IndexerBulkResource) SetRejectBlocklistedTorrentHashesWhileGrabbingNil() {
	o.RejectBlocklistedTorrentHashesWhileGrabbing.Set(nil)
}
...
func (o *IndexerBulkResource) UnsetRejectBlocklistedTorrentHashesWhileGrabbing() {
	o.RejectBlocklistedTorrentHashesWhileGrabbing.Unset()
}
...
func (o IndexerBulkResource) ToMap() (map[string]interface{}, error) {
	...
	if o.RejectBlocklistedTorrentHashesWhileGrabbing.IsSet() {
		toSerialize["rejectBlocklistedTorrentHashesWhileGrabbing"] = o.RejectBlocklistedTorrentHashesWhileGrabbing.Get()
	}
