...
type SystemResource struct {
	...
	DatabaseVersion NullableString `json:"databaseVersion,omitempty"`
	Authentication *AuthenticationType `json:"authentication,omitempty"`
	MigrationVersion *int32 `json:"migrationVersion,omitempty"`
	UrlBase NullableString `json:"urlBase,omitempty"`
	RuntimeVersion NullableString `json:"runtimeVersion,omitempty"`
...
func (o *SystemResource) GetRuntimeVersion() string {
	if o == nil || IsNil(o.RuntimeVersion.Get()) {
		var ret string
		return ret
	}
	return *o.RuntimeVersion.Get()
}
...
func (o SystemResource) ToMap() (map[string]interface{}, error) {
	...
	if o.DatabaseVersion.IsSet() {
		toSerialize["databaseVersion"] = o.DatabaseVersion.Get()
	}
	...
	if o.RuntimeVersion.IsSet() {
		toSerialize["runtimeVersion"] = o.RuntimeVersion.Get()
	}
