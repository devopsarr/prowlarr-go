...
func (o *DownloadClientResource) GetCategories() []DownloadClientCategory {
	if o == nil {
		var ret []DownloadClientCategory
		return ret
	}
	return o.Categories
}
...
func (o *DownloadClientResource) GetSupportsCategories() bool {
	if o == nil || IsNil(o.SupportsCategories) {
		var ret bool
		return ret
	}
	return *o.SupportsCategories
}

// GetSupportsCategoriesOk returns a tuple with the SupportsCategories field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DownloadClientResource) GetSupportsCategoriesOk() (*bool, bool) {
	if o == nil || IsNil(o.SupportsCategories) {
		return nil, false
	}
	return o.SupportsCategories, true
}
...
func (o DownloadClientResource) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.SupportsCategories) {
		toSerialize["supportsCategories"] = o.SupportsCategories
	}
