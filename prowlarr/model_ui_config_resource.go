...
func (o *UiConfigResource) GetUiLanguage() string {
	if o == nil || IsNil(o.UiLanguage.Get()) {
		var ret string
		return ret
	}
	return *o.UiLanguage.Get()
}
...
func (o UiConfigResource) ToMap() (map[string]interface{}, error) {
	...
	if o.UiLanguage.IsSet() {
		toSerialize["uiLanguage"] = o.UiLanguage.Get()
	}
	if o.Theme.IsSet() {
