...
type HealthResource struct {
	...
	WikiUrl NullableString `json:"wikiUrl,omitempty"`
}
...
// GetWikiUrl returns the WikiUrl field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *HealthResource) GetWikiUrl() string {
	if o == nil || IsNil(o.WikiUrl.Get()) {
		var ret string
		return ret
	}
...
// SetWikiUrl gets a reference to the given NullableString and assigns it to the WikiUrl field.
func (o *HealthResource) SetWikiUrl(v string) {
	o.WikiUrl.Set(&v)
}
// SetWikiUrlNil sets the value for WikiUrl to be an explicit nil
func (o *HealthResource) SetWikiUrlNil() {
	o.WikiUrl.Set(nil)
}
...
func (o HealthResource) ToMap() (map[string]interface{}, error) {
	...
	if o.WikiUrl.IsSet() {
		toSerialize["wikiUrl"] = o.WikiUrl.Get()
	}
