...
func (o *HostConfigResource) GetLogSizeLimit() int32 {
	if o == nil || IsNil(o.LogSizeLimit) {
		var ret int32
		return ret
	}
	return *o.LogSizeLimit
}

// GetLogSizeLimitOk returns a tuple with the LogSizeLimit field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *HostConfigResource) GetLogSizeLimitOk() (*int32, bool) {
	if o == nil || IsNil(o.LogSizeLimit) {
		return nil, false
	}
	return o.LogSizeLimit, true
}
...
func (o *HostConfigResource) SetHistoryCleanupDays(v int32) {
	o.HistoryCleanupDays = &v
}

// GetTrustCgnatIpAddresses returns the TrustCgnatIpAddresses field value if set, zero value otherwise.
func (o *HostConfigResource) GetTrustCgnatIpAddresses() bool {
	if o == nil || IsNil(o.TrustCgnatIpAddresses) {
		var ret bool
		return ret
	}
	return *o.TrustCgnatIpAddresses
}

// GetTrustCgnatIpAddressesOk returns a tuple with the TrustCgnatIpAddresses field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *HostConfigResource) GetTrustCgnatIpAddressesOk() (*bool, bool) {
	if o == nil || IsNil(o.TrustCgnatIpAddresses) {
		return nil, false
	}
	return o.TrustCgnatIpAddresses, true
}
...
// SetTrustCgnatIpAddresses gets a reference to the given bool and assigns it to the TrustCgnatIpAddresses field.
func (o *HostConfigResource) SetTrustCgnatIpAddresses(v bool) {
	o.TrustCgnatIpAddresses = &v
}
...
func (o HostConfigResource) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.LogSizeLimit) {
		toSerialize["logSizeLimit"] = o.LogSizeLimit
	}
	...
	if !IsNil(o.TrustCgnatIpAddresses) {
		toSerialize["trustCgnatIpAddresses"] = o.TrustCgnatIpAddresses
	}
